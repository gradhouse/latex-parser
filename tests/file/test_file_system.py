...
def test_create_directory_success(mocker):
    ...
    mock_is_object = mocker.patch('latex_parser.file.file_system.FileSystem.is_object', return_value=False)
...
def test_create_directory_already_exists(mocker):
    ...
    mock_is_object = mocker.patch('latex_parser.file.file_system.FileSystem.is_object', return_value=True)
    directory_path = '/path/to/directory'
...
def test_remove_directory_success(mocker):
    ...
    mock_is_directory = mocker.patch('latex_parser.file.file_system.FileSystem.is_directory', return_value=True)
...
def test_remove_directory_not_a_directory(mocker):
    ...
    mock_is_directory = mocker.patch('latex_parser.file.file_system.FileSystem.is_directory', return_value=False)
    directory_path = '/path/to/directory'
...
def test_get_file_timestamp_mocked(mocker):
    ...
    mock_is_file = mocker.patch("latex_parser.file.file_system.FileSystem.is_file", return_value=True)
